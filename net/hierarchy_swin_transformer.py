...
def HierarchySwin_T(num_classes=1000):  # Swin Tiny
...
def HierarchySwin_S(num_classes=1000):  # Swin Small
    return SwinTransformer(dims=(96, 192, 384, 768),
                           num_blocks=(2, 2, 18, 2),
                           num_heads=(3, 6, 12, 24),
                           num_classes=num_classes)
...
def HierarchySwin_B(num_classes=1000):  # Swin Base
...
def HierarchySwin_L(num_classes=1000):  # Swin Large
